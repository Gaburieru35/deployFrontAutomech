    ...
    fetchUser(controller, tipo){
        ...
        fetch(`https://4.227.162.137:443/${controller}/logar/${email}`, {
            ...
            if(senha === data.senha){
                ...
                let hrefOficina = window.location.protocol + `//auto-mech-oficina-h31vdcar3-gabrielmatosmartins-projects.vercel.app/home?id=${data.userId}&tipo=${tipo}` //localhost:3000/home?id=${data.userId}&tipo=${tipo}
